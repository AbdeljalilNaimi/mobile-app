    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-background to-muted">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle>{t('loginPage', 'citizenSpace')}</CardTitle>
          <CardDescription>{t('loginPage', 'citizenDesc')}</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">{t('loginPage', 'or')}</span>
              </div>
            </div>
        ...
        <CardFooter className="flex flex-col gap-4">
          <p className="text-sm text-muted-foreground text-center">
            ...
            <Link to="/citizen/register" className="text-primary hover:underline">{t('loginPage', 'createAccount')}</Link>
          </p>
